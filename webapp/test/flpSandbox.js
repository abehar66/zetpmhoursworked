		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zetpmhoursworked-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zetpmhoursworked-display": {
								"semanticObject": "zetpmhoursworked",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zetpmhoursworked",
									"url": sap.ui.require.toUrl("zetpmhoursworked")
								}
							}
						}
					}
